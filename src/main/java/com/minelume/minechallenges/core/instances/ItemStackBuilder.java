...
public class ItemStackBuilder {
    ...
    public static ItemStack create(Material material, int amount, int id) {
        return new ItemStack(material, amount, (short)id);
    }
    public static ItemStack create(Material material, int amount, int id, String name) {
        ItemStack itemStack = create(material, amount, id);
    ...
    public static ItemStack create(Material material, int amount, int id, String name, List<String> lore) {
        ItemStack itemStack = create(material, amount, id);
        ItemMeta itemMeta = itemStack.getItemMeta();
    ...
    public static ItemStack createSkull(int amount, String owner, String name) {
        ItemStack itemStack = new ItemStack(Material.PLAYER_HEAD, amount, (short) 0);
    ...
    public static ItemStack create(Material bow, int i, int i1, Object o) {
        return null;
    }
}
